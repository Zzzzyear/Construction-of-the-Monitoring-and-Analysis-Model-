% Load the dataset.
file_path = 'C:\Users\ZQN\Desktop\SCL90.csv';
...
% Draw a scatter plot.
scatter(1:100, r_values,'o');
xlabel('Sample Number');
ylabel('Grey Relation (r)');
title('Scatter Plot of Grey Relation Coefficients for 100 Diagnosed Students ');
grid on;
